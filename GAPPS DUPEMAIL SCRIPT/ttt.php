...
//$sql = "INSERT INTO '7c3_posts' (`post_title`, `post_author`, `post_content`, `post_categories`, `post_tags` ,`post_status`) 
//VALUES ('".$_POST["post_title"]."','".$_POST["post_author"]."','".$_POST["post_content"]."','".$_POST["post_categories"]."','".$_POST["post_tags"]."','"publish"' )";
...
/**
	...
	public function createPost()
	{
		...
		if (!$this->_client->query('wp.newPost', 1, $dbuser, $dbpass, $this->_postData))
