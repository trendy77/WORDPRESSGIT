    ...
    <div class="container push-top">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h2>{{ trans('media.create_personality_quiz') }}</h2>
                        <div id="alertStatus"></div>
                        <form id="createPersonalityForm" novalidate="novalidate">
                            {!! csrf_field() !!}
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group" v-show="questions[question_index].media_type == 1">
                                                <label for="">{{ trans('media.images') }}</label>
                                            ...
                                            <div v-for="(index, answer) in questions[question_index].answers" class="answerCtr form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">{{ trans('media.points') }}</label>
                                                    <div class="col-sm-8">
                                                        <input type="number" class="form-control" placeholder="{{ trans('media.answer') }}" v-model="answer.points">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@section( 'scripts' )
    ...
    <script src="{{ jasko_component('/components/core/js/create-personality.min.js') }}"></script>
@endsection