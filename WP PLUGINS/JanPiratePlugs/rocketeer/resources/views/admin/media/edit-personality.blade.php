...
@section('content')
    <div class="content-wrapper" id="editMediaApp">
        ...
        <section class="content-header">
            <h1>Edit Personality  <small>Edit any personality here.</small></h1>
            <ol class="breadcrumb">
                <li>Home</li>
                <li>Media</li>
                    ...
                    <div class="modal-body">
                        ...
                        <div v-for="(index, answer) in questions[question_index].answers" class="answerCtr form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" placeholder="Answer" v-model="answer.points">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="editResultModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        <h4 class="modal-title"><i class="fa fa-plus"></i> Edit Result</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Title</label>
...
@section( 'scripts' )
    ...
    <script src="{{ jasko_component('/components/core/admin/js/edit-personality.js') }}"></script>
@endsection