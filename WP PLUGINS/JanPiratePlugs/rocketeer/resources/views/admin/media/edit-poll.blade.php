...
<div class="content-wrapper" id="editMediaApp">
    ...
    <section class="content-header">
        <h1>Edit Poll <small>Edit any poll here.</small></h1>
        <ol class="breadcrumb">
            <li>Home</li>
            <li>Media</li>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="questions_tab">
                                ...
                                <div class="form-group">
                                    <label for="inputAnimation">Animation</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h3>
                                            Questions
                                            <button type="button" class="btn btn-info pull-right" v-on:click="addQuestion"><i class="fa fa-plus"></i> Add</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-pencil"></i> Edit Question</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group" v-show="questions[question_index].media_type == 9">
                        <label>Quote</label>
                    ...
                    <h3>
                        Answers
                        <button type="button" class="btn btn-info pull-right btn-sm" v-on:click="addAnswer">
...
@section( 'scripts' )
    ...
    <script src="{{ jasko_component('/components/core/admin/js/edit-poll.js') }}"></script>
@endsection