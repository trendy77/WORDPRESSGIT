...
class PersonalityController extends Controller
{
    public function create_page(){
        ...
        return view( 'media.personality.create' )->with([
            'site_title'            =>  trans('media.create_personality_quiz') . ' - ' . $settings->site_title,
    ...
    public function create(Request $request){
        ...
        $media                      =   Media::create([
            ...
            "content"               =>  $contentObj,
            "media_type"            =>  3,
            "thumbnail"             =>  $request->input('nsfw') == 2 ? $site_settings->nsfw_img : JaskoHelper::thumbnail( $request->input('thumbnail'), 'personality' ),
            "featured_img"          =>  $request->input('nsfw') == 2 ? $site_settings->nsfw_img : JaskoHelper::featured_image( $request->input('thumbnail'),  'personality' ),
            "share_img"             =>  $request->input('nsfw') == 2 ? $site_settings->nsfw_img : JaskoHelper::share_img( $request->input('thumbnail'), 'personality', $request->input('title') ),
            "uid"                   =>  $user->id,
    ...
    public function page($name, Request $request){
        ...
        return view( 'media.personality.page' )->with([
