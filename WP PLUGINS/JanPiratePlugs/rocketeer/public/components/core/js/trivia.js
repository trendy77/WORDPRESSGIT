...
(function($, w){
    ...
    function processQuiz(){
        ...
        // Modal
        $("#modalQuizResultTxt").html( triviaObj.results[result_index].title );
        $("#modalQuizResultImg").attr( 'src', ajaxurl + '/public/uploads/' + triviaObj.results[result_index].main_img );
        $("#modalQuizResultDesc").html( triviaObj.results[result_index].desc );
