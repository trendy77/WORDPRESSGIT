...
<div class = "wrap wpvr_wrap" style = "display:none;">
	...
	<div class = "wpvr_welcome_content">
		...
		<div class = "wpvr_welcome_content_wrap">
			...
			<table>
				<tr>
					<td class = "wpvr_welcome_content_left ">
						<div>

							<p>
								Thank you for using our plugin ! We had worked very hard to release a great, stable and improved
								product and we will commit to offer the best support for WPVR and fix all the reported issues.
							</p>

							<p>
								Our new goal is to make the plugin easier to use and more user friendly.
							...
							<a href = "<?php echo $changelog_url; ?>" target = "_blank" style="">
								<button class = "wpvr_button wpvr_black_button">
									<?php echo __( 'Check out what\'s new on this version' , WPVR_LANG ); ?>
								</button>
							</a>
							<?php } ?>
							
						</div>
						<div class = "wpvr_welcome_content_buttons">
							<br/>
							<button
								changelog_url = "<?php echo WPVR_URL.'wpvr.changelog.txt'; ?>"
								changelog_title = "WP VIDEO ROBOT - Versions Changelog"
								class = "wpvr_read_changelog wpvr_button  wpvr_black_button pull-left wpvr_welcome_button"
							>
								<i class = "fa fa-file-text-o"></i>
								<?php echo __( 'Version Changelog' , WPVR_LANG ); ?>
							</button>
							<button
								class = "wpvr_import_sample_sources wpvr_button  pull-left wpvr_welcome_button"
							>
								<i class = "fa fa-tv"></i>
					...
					<td class = "wpvr_welcome_content_right">
						<img width = "100%" src = "<?php echo WPVR_URL . 'assets/images/welcome_img.jpg'; ?>"/>
					</td>
				</tr>
			</table>
		</div>
