                            ...
                            <div class="inside">
								...
								<?php
									...
									if ( $wpvr_options['wakeUpHours'] === false ) {
										$workHours = __( 'All the time', WPVR_LANG );
									} else {
										$whA = $wpvr_options['wakeUpHoursA'] . "H00";
										$whB = $wpvr_options['wakeUpHoursB'] . "H00";
										
										$workHours = __( 'from', WPVR_LANG ) . " $whA " . __( 'to', WPVR_LANG ) . " $whB ";
									}
									...
									if ( $cron_data['last_exec'] == '' ) {
										...
										$delay_msg = '<span class="ko">' . __( 'CRON has been stopped for', WPVR_LANG ) . ' ' . wpvr_numberK( $delay ) . ' ' . __( 'seconds.', WPVR_LANG )
										             . '</span>';
									}
                                ...
                                <div class="wpvr_automation_status">
                                    ...
                                    <li>
										<?php _e( 'WP Video Robot is using', WPVR_LANG ); ?> : <?php echo $cronUsed; ?>
                                    </li>
                                    <li>
										<?php _e( 'WP Video Robot is working', WPVR_LANG ); ?> :
                                    ...
                                    <li>
                                        ...
                                        <span>
										<?php
											if ( $cron_data['first_exec'] != '' ) {
												echo $cron_data['first_exec'];
											} else {
												_e( 'Never', WPVR_LANG );
											}
										?>
