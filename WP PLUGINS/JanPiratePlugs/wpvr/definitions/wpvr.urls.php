<?php
	...
	/* IMAGES */
	if( ! defined( 'WPVR_NO_THUMB' ) ) define( 'WPVR_NO_THUMB' , WPVR_URL . "assets/images/no_thumb.png" );
	...
	if( ! defined( 'WPVR_CHANGELOG_URL' ) ) define( 'WPVR_CHANGELOG_URL' , 'http://support.wpvideorobot.com/tutorials/whats-new-on-wpvr-184/' );
